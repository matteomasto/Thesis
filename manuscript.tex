...
% \includepdf[pages=1]{chapters/couverture_these.pdf}
...
%  \cleardoublepage
%  \phantomsection
%  \addcontentsline{toc}{chapter}{Résumé de la thèse (version française)}
%  \input{chapters/thesis_summary_fr.tex}
