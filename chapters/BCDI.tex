...
It is now worth it to spend some words on the physical meaning of this new complex-valued shape function. 
Regarding its modulus we can say that it is the same as the real-valued support function of the ideal case. Its 
physical interpretation is the electron density of each unit cell in $\mathbf{R}_n$ enclosed in the finite size shape. 
Regarding the phase, for the single unit cell, it is interpreted as the projection of the displacement vector of the cell 
(with respect to the original perfect lattice position), onto the scattering vector pointing at the $hkl$ node of the 
selected Bragg peak. \\
...
\begin{figure}[H]
    ...
    \caption{Illustration of the squared modulus of the Fourier transform of a cube  }
