...
the DL prediction. The accuracy scores have been averaged for each prediction in the same image and plotted against the number
of pixels per fringe (Fig. \ref{fig:accVSovs}). This last parameter is not formally equivalent to the oversampling but in first approximation can
be used likewise. As expected, the overall DL 
