...
models for the best performances on experimental data. The models outperform interpolation obtained with biharmonic functions
...
coherent diffraction patterns against gaps of different sizes (2 to 20 pixels) along the central row. 
