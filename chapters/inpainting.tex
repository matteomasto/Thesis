...
the dilation rate increases linearly from 1 to 25. The last layer is a sigmoid function as well as for the UNet. 
The total number of trainable parameters is 4000, significantly lower than the UNet.
\\
In order to combine the hierarchical feature extraction of the UNet with the fine features capturing of the MSDNet 
...
from the input. Dilation rates of (6,4,2,1) and (5,3,2,1) were chosen respectively. 
