...
In this chapter, the ``detector - gaps problem'' in Bragg Coherent Diffraction Imaging and our approach to solve it
...
one can clearly see that the gap-regions is filled with non-physical high intensity (see Fig. \ref{fig:gap_intro_mask})
