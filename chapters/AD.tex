...
\begin{figure}[H]
  ...
  The 300 iterations of ER refinement do not alter the shape nor the pahse found by the AD model, therefore validating the solution.}
  \label{fig:adpynx_michael}
\end{figure}

% DISLOCATIONS
\subsection{BCDI patterns with multiple dislocations}
