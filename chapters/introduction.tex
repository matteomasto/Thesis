...
When performed in Bragg geometry (Bragg CDI or BCDI) the technique enables the 3D visualization, and investigation of 
the internal atomic structure of single-crystal nanoparticles 
with exceptional precision. This capability has proven valuable across diverse fields, including the study of strain 
distributions, defect populations, and particle morphologies under varying physico-chemical environments \cite. Typical BCDI 
