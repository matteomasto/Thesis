...
In this configuration, an integer step (10 pixels in our case) is chosen beforehand and the first patch around the center 
of the Bragg peak is selected together with all the patches centered in distances of integer multiples of the chosen step. 
