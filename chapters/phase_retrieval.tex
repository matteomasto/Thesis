...
\begin{figure}[H]
    ...
    \caption{Manipulation of the datasets }
    \label{fig:gauss}
\end{figure}
As expected the accuracy drops as the phase range increases, and from a visual inspection it is possible to consider 
acceptable any reconstruction with an accuracy value around $70\%$. 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/Phasing/plot_acc.pdf}
    \caption{Manipulation of the datasets }
    \label{fig:compa}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Non-centrosymm }
    \label{fig:non_centrosymm}
\end{figure}
