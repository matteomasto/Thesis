...
The architecture that was employed is an adaptation of the 3D U-Net employed for smaller patches. The number of encoder and 
decoder blocks has been increased as well as the total number of trainable parameters. Fig. \ref{fig:architecture_phasing}
